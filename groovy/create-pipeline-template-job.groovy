...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/maziarz-cbci-demo/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>maziarz-cbci-demo</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>maziarz-cbci-demo</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/maziarz-cbci-demo/pipeline-template-catalog.git</repositoryUrl>
              <traits>
